...
def checkout(request):
   ...
   if cart_product: 
      ...
      if order_status == "created":
         ...
         payment.save()
   return render(request, 'app/checkout.html', {'add':add, 'razorpayamount':razorpayamount, 'amount':amount, 'cart_items':cart_items, 'order_id': order_id,})
...
def orders(request):
    ...
    return render(request, 'app/orders.html', {'orders_with_total': orders_with_total})
